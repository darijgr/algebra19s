...
%TCIDATA{LastRevised=Monday, February 04, 2019 18:09:38}
...
\begin{itemize}
\item Section 001: MWF 9:05--9:55,
\href{http://campusmaps.umn.edu/vincent-hall}{Vincent Hall} 211.

\item Section 002: MWF 11:15--12:05,
\href{http://campusmaps.umn.edu/vincent-hall}{Vincent Hall} 211.
\end{itemize}
...
\begin{itemize}
\item Monday 14:35--15:35;

\item Tuesday 10:00--11:00;

\item Tuesday 12:00--13:00;

\item Friday 14:30--15:00 (half an hour).
\end{itemize}

Usually in \href{http://campusmaps.umn.edu/lind-hall}{Lind Hall 4th floor
(center of the hall)}. If I am not there, try
...
All material regarding the course (including homework) can be found on my
homepage \url{http://www.cip.ifi.lmu.de/~grinberg/t/19s/}.
...
\item * Solving deg-$3$ equations; higher orders.
\end{enumerate}
...
\item Gaussian integers and $n=x^{2}+y^{2}$ (follow Keith Conrad). Finish with
discussion of other quadratic and higher-order number rings.

\item Linear algebra. (Start with $\mathbb{F}\in\left\{  \mathbb{Q}%
,\mathbb{R},\mathbb{C}\right\}  $, then analyze what was used, and conclude
that $\mathbb{Z}/p$ also works. Then solve
\href{https://en.wikipedia.org/wiki/Lights_Out_(game)}{lights-out} using
$\mathbb{Z}/2$-linear algebra. Finally, do the Smith normal form over
$\mathbb{Z}$ via the Euclidean algorithm. Discuss the failure of linear
algebra of $\mathbb{Z}$ in more detail -- what works?)

\item Permutations and determinants. (Include Cayley-Hamilton \& companion
matrices. Apply to algebraic integers?)

\item Groups. (Include subgroups, homomorphisms, direct products.)
...
\textbf{Ignore the due dates so far}; I need to decide between weekly and
biweekly homework.%
