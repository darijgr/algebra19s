...
%TCIDATA{LastRevised=Saturday, April 18, 2026 22:01:17}
...
\mathbb{F}\setminus\left\{  0\right\}  $ is invertible, i.e., is a bijection.
...
is, about the factors $\mathbf{u}_{1},\mathbf{u}_{2},\ldots,\mathbf{u}_{k}$ in
...
irreducible divisor $\mathbf{a}$ of the polynomial  $x^{p^{mr}}-x$ in
...
\mathbf{a}_{2}\cdots\mathbf{a}_{k}$. Then, $\mathbf{p}\mid\mathbf{a}_{i}$ for
...
\mid\mathbf{a}_{1}\mathbf{a}_{2}\cdots\mathbf{a}_{k}$. Then, $\mathbf{p}%
...
\[
\lambda=\left(  \text{the leading coefficient of the polynomial }%
\mathbf{a}_{j}\right)  =1
\]
