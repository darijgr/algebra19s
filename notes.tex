...
%TCIDATA{LastRevised=Monday, February 04, 2019 22:01:24}
...
\left(  a,b\right)  $. In other wrods, $\operatorname*{Div}\left(  a,b\right)
...
and Proposition \ref{prop.ent.gcd.props1} \textbf{(h)}). Again, let us give
the detailed argument for the sake of completeness:
...
\begin{theorem}
\label{thm.ent.gcd.uniprop}Let $m,a,b\in\mathbb{Z}$. Then:

\textbf{(a)} We have the following logical equivalence:%
\begin{equation}
...
\begin{proof}
[Proof of Theorem \ref{thm.ent.gcd.uniprop}.]\textbf{(a)} In order to prove
...
\item $\gcd$ of multiple numbers by repeated $\gcd$ing.
