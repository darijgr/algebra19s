...
%TCIDATA{LastRevised=Monday, February 18, 2019 13:13:33}
...
that $a$ and $b$ are nonzero (since otherwise, the claim of Proposition
\ref{prop.ent.primes.gcd} easily reduces to $0=0$). Then, $ab$ is nonzero as
...
You can likewise prove generalizations to $k$ integers.
\end{remark}
\end{fineprint}
