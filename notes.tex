...
%TCIDATA{LastRevised=Wednesday, February 13, 2019 10:34:41}
...
,a_{2},\ldots,a_{k}\right)  \right)  \nonumber\\
&  =\left(  \text{the number of times }p\text{ appears in }\left(  b_{1}%
,b_{2},\ldots,b_{\ell}\right)  \right)  .\label{pf.thm.ent.primes.fac-uni.b.1}%
\end{align}
...
\begin{proof}
[Proof of Proposition \ref{prop.ent.primes.gcd}.]TODO
\end{proof}
...
\item example of previous properties rederived

\item coprimality means not having any primes in common

\item explain why $\perp$ notation
\end{itemize}
...
\subsubsection{Euler's totient function ($\phi$-function)}
