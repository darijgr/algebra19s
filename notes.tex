...
%TCIDATA{LastRevised=Tuesday, February 19, 2019 19:34:47}
...
Now, $z=\prod_{i\in C}i$. Exercise \ref{exe.ent.coprime.ab-to-cI} (applied to
$I=C$, $c=n$ and $b_{i}=i$) yields $\prod_{i\in C}i\perp n$ (since each $i\in
C$ satisfies $i\perp n$). In other words, $z\perp n$ (since $z=\prod_{i\in
C}i$).
...
\begin{theorem}
\label{thm.binom.comb-int}(Combinatorial interpretation of binomial coefficients)
