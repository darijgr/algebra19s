...
%TCIDATA{LastRevised=Monday, February 04, 2019 12:14:28}
...
\textquotedblleft coprime\textquotedblright). But Theorem
...
Hence, $xa+yb=\gcd\left(  a,b\right)  =1$. Thus, $c\left(  xa+yb\right)
=c\cdot1=c$, so that%
\[
c=c\left(  xa+yb\right)  =cxa+cyb.
\]
