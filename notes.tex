...
%TCIDATA{LastRevised=Wednesday, February 06, 2019 14:59:18}
...
a positive integer), which means that $a$ is coprime to $a+1$.

\textbf{(d)} Let $a$ be an integer. When is $a$ coprime to $2$? TODO.
\end{example}
