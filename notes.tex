...
%TCIDATA{LastRevised=Friday, February 08, 2019 08:08:50}
...
\begin{itemize}
\item Common multiples.

\item lcm: Define it as the least nonnegative common multiple.

\item $\gcd\left(  a,b\right)  \cdot\operatorname{lcm}\left(  a,b\right)
...
\item $p>1$ prime $\Longrightarrow$ $p$ coprime to $1,2,\ldots,p-1$

\item Note: converse holds too.
