...
%TCIDATA{LastRevised=Saturday, February 02, 2019 11:13:25}
...
\begin{example}
The common divisors of $6$ and $8$ are $-2,-1,1,2$. (In order to see this,
just observe that the divisors of $6$ are $-6,-3,-2,-1,1,2,3,6$, whereas the
...
We have assumed that $b_{1},b_{2},\ldots,b_{k}$ are not all $0$. In other
words, there exists an $i\in\left\{  1,2,\ldots,k\right\}  $ such that
$b_{i}\neq0$. Consider such an $i$.
