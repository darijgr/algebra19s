...
%TCIDATA{LastRevised=Saturday, February 09, 2019 15:14:45}
...
}\gcd\left(  a,b\right)  \text{ and }c\text{ instead of }x\text{ and
}y\right)  \nonumber\\
...
Next, we state an anlogue of Theorem \ref{thm.ent.gcd.uniprop} (with all
divisibilities \textquotedblleft turned around\textquotedblright):
...
\begin{proof}
[Proof of Theorem \ref{thm.ent.lcm.uniprop}.] Exercise.
\end{proof}
