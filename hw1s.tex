...
\begin{statement}
\textit{Claim 1:} For each $i\in\left\{  1,2,\ldots,n\right\}  $, we have%
\[
...
equality with $\dbinom{kb}{b}=k\dbinom{kb-1}{b-1}$, we obtain%
\[
k\dbinom{kb-1}{b-1}=\dfrac{\left(  kb\right)  !}{b!\left(  \left(  k-1\right)
b\right)  !}.
\]
...
\begin{equation}
\dfrac{b}{a+b}\dbinom{a+b}{a}=\dbinom{a+b-1}{b-1}.
