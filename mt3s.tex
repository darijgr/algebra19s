...
We have assumed that the nonunital ring $n\mathbb{Z}$ has a unity. Let us
...
\begin{statement}
\textit{Statement 4:} Let $f\in\mathbb{K}\left[  x\right]  $. Then,
...
\begin{definition}
\label{def.pol.general-binom}Let $n\in\mathbb{K}\left[  x\right]  $
...
\begin{proposition}
\label{prop.pol.general-binom.vander}Let $a,b\in\mathbb{K}
